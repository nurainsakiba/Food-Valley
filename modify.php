    ...
    <div class="register-photo">
        <div class="form-container">
			...
			<a href="show.php" class="btn btn-primary btn" role="button">Item List</a>
                <h2 class="text-center"><strong>Modify Item Price</strong></h2>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="modify"  >Modify Price</button></div>
        </div>
    </div>
