<div class="banner-bottom py-5" id="review">
...
<div class="container">
  ...
  <form method="post">
        ...
        <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Email" style="height:40px;"><input class="form-control" type="text" name="review" placeholder="Enter Review" style="height:120px;"></div>
        <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="background-color:rgb(137,244,71);width:100px;">Review</button></div>
    </form>
